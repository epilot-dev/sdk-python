...
class GrantConditionOperation(str, Enum):
    EQUALS = 'equals'
...
class GrantCondition:
    ...
    operation: GrantConditionOperation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('operation') }})
