...
class Assignments:
    ...
    def add_assignment(self, role_id: str, user_id: str) -> operations.AddAssignmentResponse:
        ...
        res = operations.AddAssignmentResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def assign_roles(self, user_id: str, request_body: Optional[List[str]] = None) -> operations.AssignRolesResponse:
        ...
        res = operations.AssignRolesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_assigned_roles_for_user(self, user_id: str) -> operations.GetAssignedRolesForUserResponse:
        ...
        res = operations.GetAssignedRolesForUserResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_all_assignments(self) -> operations.ListAllAssignmentsResponse:
        ...
        res = operations.ListAllAssignmentsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def remove_assignment(self, role_id: str, user_id: str) -> operations.RemoveAssignmentResponse:
        ...
        res = operations.RemoveAssignmentResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
