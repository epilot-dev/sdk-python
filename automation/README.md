...
```python
from epilot_automation import Epilot
from epilot_automation.utils import BackoffStrategy, RetryConfig
...
When custom error responses are specified for an operation, the SDK may also raise their associated exceptions. You can refer to respective *Errors* tables in SDK docs for more details on possible exception types for each operation. For example, the `cancel_execution_async` method may raise the following exceptions:

| Error Type                         | Status Code | Content Type     |
| ---------------------------------- | ----------- | ---------------- |
| models.CancelExecutionResponseBody | 403, 404    | application/json |
| models.APIError                    | 4XX, 5XX    | \*/\*            |

### Example

```python
from epilot_automation import Epilot, models
...
with Epilot(
    ...
    except models.CancelExecutionResponseBody as e:
        # handle e.data: models.CancelExecutionResponseBodyData
        raise(e)
...
```python
from epilot_automation import Epilot
from epilot_automation.httpclient import AsyncHttpClient
import httpx
...
s = Epilot(debug_logger=logging.getLogger("epilot_automation"))
```
<!-- End Debugging [debug] -->
