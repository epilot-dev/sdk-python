...
with Epilot(
    ...
    res = epilot.executions.get_execution(execution_id="9baf184f-bc81-4128-bca3-d974c90a12c4")
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| models.GetExecutionResponseBody | 403, 404                        | application/json                |
| models.APIError                 | 4XX, 5XX                        | \*/\*                           |
...
with Epilot(
    ...
    res = epilot.executions.get_executions(entity_id="e3d3ebac-baab-4395-abf4-50b5bf1f8b74", from_=0, size=25)
...
| Error Type                       | Status Code                      | Content Type                     |
| -------------------------------- | -------------------------------- | -------------------------------- |
| models.GetExecutionsResponseBody | 403                              | application/json                 |
| models.APIError                  | 4XX, 5XX                         | \*/\*                            |
...
with Epilot() as epilot:
    ...
    res = epilot.executions.resume_execution_with_token(request={
...
| Error Type                                  | Status Code                                 | Content Type                                |
| ------------------------------------------- | ------------------------------------------- | ------------------------------------------- |
| models.ResumeExecutionWithTokenResponseBody | 403, 404                                    | application/json                            |
| models.APIError                             | 4XX, 5XX                                    | \*/\*                                       |
...
with Epilot(
    ...
    epilot.executions.retrigger_action(action_id="9ec3711b-db63-449c-b894-54d5bb622a8f", execution_id="9baf184f-bc81-4128-bca3-d974c90a12c4")
...
| Error Type                         | Status Code                        | Content Type                       |
| ---------------------------------- | ---------------------------------- | ---------------------------------- |
| models.RetriggerActionResponseBody | 403, 404                           | application/json                   |
| models.APIError                    | 4XX, 5XX                           | \*/\*                              |
...
with Epilot(
    ...
    res = epilot.executions.start_execution(request={
...
| Error Type                        | Status Code                       | Content Type                      |
| --------------------------------- | --------------------------------- | --------------------------------- |
| models.StartExecutionResponseBody | 403                               | application/json                  |
| models.APIError                   | 4XX, 5XX                          | \*/\*                             |