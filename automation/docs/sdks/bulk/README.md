...
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| models.BulkTriggerExecutionsResponseBody | 403                                      | application/json                         |
...
| Error Type                    | Status Code                   | Content Type                  |
| ----------------------------- | ----------------------------- | ----------------------------- |
| models.GetBulkJobResponseBody | 403, 404                      | application/json              |
| models.APIError               | 4XX, 5XX                      | \*/\*                         |
...
with Epilot(
    ...
    res = epilot.bulk.patch_bulk_job(job_id="8c086140-f33e-4bb7-a993-50c0f2402c7b", action=epilot_automation.Action.APPROVE, task_token="b35a6c51-2a15-4ef1-9623-20db37b0744f")
...
| `task_token`                                                        | *str*                                                               | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |                                                                     |
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| models.PatchBulkJobResponseBody | 403, 404                        | application/json                |
| models.APIError                 | 4XX, 5XX                        | \*/\*                           |