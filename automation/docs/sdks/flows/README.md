...
with Epilot(
    ...
    res = epilot.flows.delete_flow(flow_id="7791b04a-16d2-44a2-9af9-2d59c25c512f")
...
with Epilot(
    ...
    res = epilot.flows.put_flow(flow_id="7791b04a-16d2-44a2-9af9-2d59c25c512f", automation_flow={
        "flow_name": "Handle contact form",
        "triggers": [
...
with Epilot(
    ...
    res = epilot.flows.search_flows(schema="submission", trigger_source_id="600945fe-212e-4b97-acf7-391d64648384")
