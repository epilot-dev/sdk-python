...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `configuration`                                                                                              | [components.EntityOperationTriggerConfiguration](../../models/shared/entityoperationtriggerconfiguration.md) | :heavy_check_mark:                                                                                           | N/A                                                                                                          |
| `type`                                                                                                       | [components.EntityOperationTriggerType](../../models/shared/entityoperationtriggertype.md)                   | :heavy_check_mark:                                                                                           | N/A                                                                                                          |