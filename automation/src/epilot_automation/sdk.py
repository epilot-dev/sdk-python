...
from epilot_automation._hooks import SDKHooks
from epilot_automation.bulk import Bulk
from epilot_automation.executions import Executions
from epilot_automation.flows import Flows
from epilot_automation.types import OptionalNullable, UNSET
import httpx
...
class Epilot(BaseSDK):
    ...
    def _init_sdks(self):
        ...
        self.bulk = Bulk(self.sdk_configuration)
