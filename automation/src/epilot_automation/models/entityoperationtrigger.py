...
EntityOperationTriggerSchemasTypeTypedDict = TypeAliasType(
...
EntityOperationTriggerSchemasType = TypeAliasType(
...
DiffTypedDict = TypeAliasType(
    "DiffTypedDict",
    Union[OrConditionForDiffTypedDict, EntityOperationTrigger2TypedDict],
)


Diff = TypeAliasType("Diff", Union[OrConditionForDiff, EntityOperationTrigger2])
