...
class TriggerWebhookActionConfigReasonTypedDict(TypedDict):
...
class TriggerWebhookActionConfigReason(BaseModel):
...
class TriggerWebhookActionConfigTypedDict(TypedDict):
    ...
    reason: NotRequired[TriggerWebhookActionConfigReasonTypedDict]
    schedule_id: NotRequired[str]
    r"""Schedule Id which indicates the schedule of the action"""
    type: NotRequired[TriggerWebhookActionConfigType]


class TriggerWebhookActionConfig(BaseModel):
    ...
    reason: Optional[TriggerWebhookActionConfigReason] = None

    schedule_id: Optional[str] = None
    r"""Schedule Id which indicates the schedule of the action"""

    type: Optional[TriggerWebhookActionConfigType] = None
