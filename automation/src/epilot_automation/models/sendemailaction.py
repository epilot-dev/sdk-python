...
class SendEmailActionReasonTypedDict(TypedDict):
...
class SendEmailActionReason(BaseModel):
...
class SendEmailActionTypedDict(TypedDict):
    ...
    reason: NotRequired[SendEmailActionReasonTypedDict]
    ...
    type: NotRequired[SendEmailActionType]
...
class SendEmailAction(BaseModel):
    ...
    reason: Optional[SendEmailActionReason] = None
    ...
    type: Optional[SendEmailActionType] = None
