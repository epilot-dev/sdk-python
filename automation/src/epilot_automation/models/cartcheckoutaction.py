...
class CartCheckoutActionReasonTypedDict(TypedDict):
...
class CartCheckoutActionReason(BaseModel):
...
class CartCheckoutActionTypedDict(TypedDict):
    ...
    reason: NotRequired[CartCheckoutActionReasonTypedDict]
    ...
    type: NotRequired[CartCheckoutActionType]
    updated_at: NotRequired[str]


class CartCheckoutAction(BaseModel):
    r"""Creates an order entity with prices from journey"""
    ...
    reason: Optional[CartCheckoutActionReason] = None
    ...
    type: Optional[CartCheckoutActionType] = None
