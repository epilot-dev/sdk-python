...
class ConditionStatementOrigin(str, Enum):
    TRIGGER = "trigger"
    ACTION = "action"
...
class Source(BaseModel):
    ...
    attribute_operation: Annotated[
        Optional[AttributeOperation], pydantic.Field(alias="attributeOperation")
    ] = None

    attribute_repeatable: Annotated[
        Optional[bool], pydantic.Field(alias="attributeRepeatable")
    ] = None
    ...
    origin: Optional[ConditionStatementOrigin] = None

    origin_type: Annotated[Optional[OriginType], pydantic.Field(alias="originType")] = (
        None
    )
