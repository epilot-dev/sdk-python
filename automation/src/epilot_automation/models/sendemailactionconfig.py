...
from .sendemailconfig import SendEmailConfig, SendEmailConfigTypedDict
...
class SendEmailActionConfigReasonTypedDict(TypedDict):
...
class SendEmailActionConfigReason(BaseModel):
...
class SendEmailActionConfigTypedDict(TypedDict):
    ...
    config: NotRequired[SendEmailConfigTypedDict]
    ...
    reason: NotRequired[SendEmailActionConfigReasonTypedDict]
    schedule_id: NotRequired[str]
    r"""Schedule Id which indicates the schedule of the action"""
    type: NotRequired[SendEmailActionConfigType]
...
class SendEmailActionConfig(BaseModel):
    ...
    config: Optional[SendEmailConfig] = None
    ...
    reason: Optional[SendEmailActionConfigReason] = None

    schedule_id: Optional[str] = None
    r"""Schedule Id which indicates the schedule of the action"""

    type: Optional[SendEmailActionConfigType] = None
