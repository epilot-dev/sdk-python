...
class TriggerWorkflowActionReasonTypedDict(TypedDict):
...
class TriggerWorkflowActionReason(BaseModel):
...
class TriggerWorkflowActionTypedDict(TypedDict):
    ...
    reason: NotRequired[TriggerWorkflowActionReasonTypedDict]
    ...
    type: NotRequired[TriggerWorkflowActionType]
    updated_at: NotRequired[str]


class TriggerWorkflowAction(BaseModel):
    ...
    reason: Optional[TriggerWorkflowActionReason] = None
    ...
    type: Optional[TriggerWorkflowActionType] = None
