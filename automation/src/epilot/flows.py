...
class Flows:
    ...
    def create_flow(self, request: Optional[components.AutomationFlowInput]) -> operations.CreateFlowResponse:
        ...
        res = operations.CreateFlowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete_flow(self, flow_id: str) -> operations.DeleteFlowResponse:
        ...
        res = operations.DeleteFlowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_flow(self, flow_id: str) -> operations.GetFlowResponse:
        ...
        res = operations.GetFlowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def put_flow(self, flow_id: str, automation_flow: Optional[components.AutomationFlowInput] = None) -> operations.PutFlowResponse:
        ...
        res = operations.PutFlowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def search_flows(self, from_: Optional[int] = None, schema: Optional[str] = None, size: Optional[int] = None, trigger_source_id: Optional[str] = None) -> operations.SearchFlowsResponse:
        ...
        query_params = { **utils.get_query_params(operations.SearchFlowsRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.SearchFlowsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
