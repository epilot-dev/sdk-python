...
from ...models.components import retryreq as components_retryreq
...
class RetriggerActionRequest:
    ...
    r"""Execution Id"""
    retry_req: Optional[components_retryreq.RetryReq] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
