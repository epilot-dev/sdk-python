...
class APICallerContextEpilotAuthClaims:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class APICallerContextEpilotAuth:
    claims: Optional[APICallerContextEpilotAuthClaims] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('claims'), 'exclude': lambda f: f is None }})
...
class APICallerContext:
    ...
    epilot_auth: Optional[APICallerContextEpilotAuth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EpilotAuth'), 'exclude': lambda f: f is None }})
