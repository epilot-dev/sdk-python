...
from ..shared import entityitemsnapshot as shared_entityitemsnapshot
...
class AutomationExecution:
    ...
    entity_snapshot: Optional[shared_entityitemsnapshot.EntityItemSnapshot] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_snapshot'), 'exclude': lambda f: f is None }})
