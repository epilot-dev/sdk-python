...
import dataclasses
from ..shared import apicallercontext as shared_apicallercontext
...
class TriggerEventManual:
    ...
    caller: Optional[shared_apicallercontext.APICallerContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('caller'), 'exclude': lambda f: f is None }})
