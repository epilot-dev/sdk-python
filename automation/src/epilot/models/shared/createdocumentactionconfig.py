...
class CreateDocumentActionConfig:
    ...
    config: Optional[shared_createdocumentconfig.CreateDocumentConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is None }})
