...
class CreateDocumentActionConfig:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='create-document', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
