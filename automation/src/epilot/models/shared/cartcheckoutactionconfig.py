...
class CartCheckoutActionConfig:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='cart-checkout', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
