...
class TriggerWorkflowActionConfigReason:
...
class TriggerWorkflowActionConfig:
    ...
    reason: Optional[TriggerWorkflowActionConfigReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
