...
class SendEmailConfigSourceFilter:
...
@dataclasses.dataclass
class Attachments:
    source_filter: Optional[SendEmailConfigSourceFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source_filter'), 'exclude': lambda f: f is None }})
    r"""Specify filters to match file entities related to main entity"""
