...
import dataclasses
from .conditionconfig import ConditionConfig
...
class ConditionActionConfigReason:
...
class ConditionActionConfigType(str, Enum):
    CONDITION = 'condition'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ConditionActionConfig:
    ...
    config: Optional[ConditionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is None }})
    ...
    reason: Optional[ConditionActionConfigReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    type: Optional[ConditionActionConfigType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
