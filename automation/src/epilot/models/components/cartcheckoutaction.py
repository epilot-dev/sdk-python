...
class CartCheckoutActionReason:
...
class CartCheckoutActionType(str, Enum):
...
class CartCheckoutAction:
    ...
    reason: Optional[CartCheckoutActionReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[CartCheckoutActionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
