...
class TriggerWorkflowActionReason:
...
class TriggerWorkflowActionType(str, Enum):
...
class TriggerWorkflowAction:
    ...
    reason: Optional[TriggerWorkflowActionReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[TriggerWorkflowActionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
