...
import dataclasses
from .apicallercontext import APICallerContext
...
class TriggerEventManual:
    ...
    caller: Optional[APICallerContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('caller'), 'exclude': lambda f: f is None }})
