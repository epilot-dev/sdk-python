...
from .triggerwebhookconfig import TriggerWebhookConfig
...
class TriggerWebhookActionReason:
...
class TriggerWebhookAction:
    ...
    config: Optional[TriggerWebhookConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is None }})
    ...
    reason: Optional[TriggerWebhookActionReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[TriggerWebhookActionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
