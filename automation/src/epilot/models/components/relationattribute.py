...
class RelationAttribute:
    ...
    source_filter: Optional[SourceFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source_filter'), 'exclude': lambda f: f is None }})
    r"""A filter to identify which source entities to pick as relations from main entity"""
