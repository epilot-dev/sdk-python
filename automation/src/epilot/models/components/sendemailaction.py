...
from .sendemailconfig import SendEmailConfig
...
class SendEmailActionType(str, Enum):
...
class SendEmailAction:
    ...
    config: Optional[SendEmailConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is None }})
    ...
    reason: Optional[SendEmailActionReason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[SendEmailActionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
