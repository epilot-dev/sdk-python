...
from .operationobjectnode import OperationObjectNode
...
class MappingAttributeV2:
    operation: Union[OperationObjectNode, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('operation') }})
