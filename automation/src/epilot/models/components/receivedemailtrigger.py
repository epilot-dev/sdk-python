...
class ReceivedEmailTriggerConfiguration:
    message_type: Optional[MessageType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message_type'), 'exclude': lambda f: f is None }})
