...
class UpsertPortalConfigImages:
    ...
    order_left_teaser: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderLeftTeaser'), 'exclude': lambda f: f is UpsertPortalConfigImages.UNSET }})
    r"""URL of the order left teaser image"""
    order_right_teaser: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderRightTeaser'), 'exclude': lambda f: f is UpsertPortalConfigImages.UNSET }})
    r"""URL of the order right teaser image"""
    welcome_banner: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('welcomeBanner'), 'exclude': lambda f: f is UpsertPortalConfigImages.UNSET }})
