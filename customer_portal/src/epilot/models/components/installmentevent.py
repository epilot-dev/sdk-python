...
class InstallmentEventDollarRelation:
...
class InstallmentEventContract:
    dollar_relation: Optional[List[InstallmentEventDollarRelation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('$relation'), 'exclude': lambda f: f is None }})
