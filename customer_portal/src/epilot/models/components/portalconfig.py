...
@dataclasses.dataclass
class EntityActions:
    action_label: Optional[ActionLabel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action_Label'), 'exclude': lambda f: f is None }})
...
class EntityEditRules:
    ...
    cadence_period_type: Optional[CadencePeriodType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence_period_type'), 'exclude': lambda f: f is None }})
    ...
    rule_type: Optional[RuleType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rule_type'), 'exclude': lambda f: f is None }})
    slug: Optional[EntitySlug] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('slug'), 'exclude': lambda f: f is None }})
    r"""URL-friendly identifier for the entity schema"""
...
class EntityIdentifiers:
    ...
    type: Optional[PortalConfigType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
class OrgSettings:
    ...
    canary: Optional[Canary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('canary'), 'exclude': lambda f: f is None }})
    r"""Canary feature flag"""
    release_candidate: Optional[ReleaseCandidate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('release_candidate'), 'exclude': lambda f: f is None }})
    r"""Release candidate settings"""
...
class PortalConfig:
    ...
    cognito_details: Optional[CognitoDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cognito_details'), 'exclude': lambda f: f is None }})
    r"""AWS Cognito Pool details for the portal"""
    ...
    """
    default_user_to_notify: Optional[DefaultUserToNotify] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_user_to_notify'), 'exclude': lambda f: f is None }})
    r"""Default 360 user to notify upon an internal notification"""
    ...
    entity_actions: Optional[List[EntityActions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_actions'), 'exclude': lambda f: f is None }})
    r"""Journey actions allowed on an entity by a portal user"""
    entity_edit_rules: Optional[List[EntityEditRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_edit_rules'), 'exclude': lambda f: f is None }})
    r"""Rules for editing an entity by a portal user"""
    entity_identifiers: Optional[EntityIdentifiers] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_identifiers'), 'exclude': lambda f: f is None }})
    r"""Identifiers used to identify an entity by a portal user"""
    feature_settings: Optional[FeatureSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('feature_settings'), 'exclude': lambda f: f is None }})
    r"""Feature settings for the portal"""
