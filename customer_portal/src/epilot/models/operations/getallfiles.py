...
class GetAllFilesResponseBody:
    ...
    results: Optional[List[components_fileitem.FileItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
...
class GetAllFilesResponse:
    ...
    object: Optional[GetAllFilesResponseBody] = dataclasses.field(default=None)
    r"""The files have been fetched successfully."""
