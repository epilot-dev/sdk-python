...
class Ecp:
    ...
    def get_search_results_for_opportunities(self, security: operations.GetSearchResultsForOpportunitiesSecurity, request_body: operations.GetSearchResultsForOpportunitiesRequestBody, from_: Optional[float] = None, size: Optional[float] = None) -> operations.GetSearchResultsForOpportunitiesResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.GetSearchResultsForOpportunitiesRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.GetSearchResultsForOpportunitiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_searchable_attributes_for_opportunities(self, security: operations.GetSearchableAttributesForOpportunitiesSecurity, from_: Optional[float] = None, size: Optional[float] = None) -> operations.GetSearchableAttributesForOpportunitiesResponse:
        ...
        headers = {}
        query_params = utils.get_query_params(operations.GetSearchableAttributesForOpportunitiesRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.GetSearchableAttributesForOpportunitiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def search_payment_relations_in_entities(self, id: str) -> operations.SearchPaymentRelationsInEntitiesResponse:
        ...
        res = operations.SearchPaymentRelationsInEntitiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def search_portal_user_entities(self, request: Optional[components.EntitySearchParams], security: operations.SearchPortalUserEntitiesSecurity) -> operations.SearchPortalUserEntitiesResponse:
        ...
        res = operations.SearchPortalUserEntitiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def validate_cadence_entity_edit_rules(self, id: str, slug: components.EntitySlug, attribute: Optional[datetime] = None) -> operations.ValidateCadenceEntityEditRulesResponse:
        ...
        headers = {}
        query_params = utils.get_query_params(operations.ValidateCadenceEntityEditRulesRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.ValidateCadenceEntityEditRulesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
