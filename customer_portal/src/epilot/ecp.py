...
class Ecp:
    ...
    def add_end_customer_relation_to_entity(self, security: operations.AddEndCustomerRelationToEntitySecurity, id: str, slug: shared.EntitySlug) -> operations.AddEndCustomerRelationToEntityResponse:
    ...
    def create_custom_entity_activity(self, security: operations.CreateCustomEntityActivitySecurity, activity: Optional[shared.Activity] = None, entities: Optional[List[str]] = None) -> operations.CreateCustomEntityActivityResponse:
    ...
    def get_entities_by_identifiers(self, security: operations.GetEntitiesByIdentifiersSecurity, request_body: Dict[str, Any], slug: shared.EntitySlug) -> operations.GetEntitiesByIdentifiersResponse:
