...
class ECPAdmin:
    ...
    def can_trigger_portal_flow(self, trigger_portal_flow: components.TriggerPortalFlow, origin: components.Origin) -> operations.CanTriggerPortalFlowResponse:
        ...
        query_params = { **utils.get_query_params(operations.CanTriggerPortalFlowRequest, request), **query_params }
        ...
        res = operations.CanTriggerPortalFlowResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[operations.CanTriggerPortalFlowResponseBody])
                res.object = out
            else:
    ...
    def configure_distribution(self, origin: components.Origin) -> operations.ConfigureDistributionResponse:
        ...
        res = operations.ConfigureDistributionResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def create_sso_user(self, create_sso_user_request: components.CreateSSOUserRequest, origin: components.Origin) -> operations.CreateSSOUserResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.CreateSSOUserRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.CreateSSOUserResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete_portal(self, origin: components.Origin) -> operations.DeletePortalResponse:
        ...
        res = operations.DeletePortalResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def extra_permission_attributes(self) -> operations.ExtraPermissionAttributesResponse:
        ...
        res = operations.ExtraPermissionAttributesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def fetch_portal_users_by_related_entity(self, entity_id: str, slug: components.EntitySlug) -> operations.FetchPortalUsersByRelatedEntityResponse:
        ...
        res = operations.FetchPortalUsersByRelatedEntityResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def filter_users_to_notify_on_automation(self, request: Optional[operations.FilterUsersToNotifyOnAutomationRequestBody]) -> operations.FilterUsersToNotifyOnAutomationResponse:
        r"""filterUsersToNotifyOnAutomation
        Filters the portal user emails to notify on automation
        """
        hook_ctx = HookContext(operation_id='filterUsersToNotifyOnAutomation', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = base_url + '/v2/portal/users-to-notify'
        ...
        req_content_type, data, form = utils.serialize_request_body(request, Optional[operations.FilterUsersToNotifyOnAutomationRequestBody], "request", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.FilterUsersToNotifyOnAutomationResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[operations.FilterUsersToNotifyOnAutomationResponseBody])
                res.object = out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def get_all_portal_configs(self) -> operations.GetAllPortalConfigsResponse:
        ...
        res = operations.GetAllPortalConfigsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_ecp_contact(self, id: str) -> operations.GetECPContactResponse:
        ...
        res = operations.GetECPContactResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_email_templates(self, origin: components.Origin) -> operations.GetEmailTemplatesResponse:
        ...
        res = operations.GetEmailTemplatesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_entity_identifiers(self, slug: components.EntitySlug) -> operations.GetEntityIdentifiersResponse:
        ...
        res = operations.GetEntityIdentifiersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_org_portal_config(self, origin: components.Origin) -> operations.GetOrgPortalConfigResponse:
        ...
        res = operations.GetOrgPortalConfigResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_registration_identifiers(self) -> operations.GetRegistrationIdentifiersResponse:
        ...
        res = operations.GetRegistrationIdentifiersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetRegistrationIdentifiersResponseBody])
                res.object = out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def get_valid_secondary_attributes(self) -> operations.GetValidSecondaryAttributesResponse:
        ...
        res = operations.GetValidSecondaryAttributesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def login_to_portal_as_user(self, request: operations.LoginToPortalAsUserRequestBody) -> operations.LoginToPortalAsUserResponse:
        ...
        res = operations.LoginToPortalAsUserResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def replace_ecp_template_variables(self, request: Optional[Dict[str, operations.RequestBody]]) -> operations.ReplaceECPTemplateVariablesResponse:
        ...
        res = operations.ReplaceECPTemplateVariablesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def save_portal_files(self, request: components.SavePortalFile) -> operations.SavePortalFilesResponse:
        ...
        res = operations.SavePortalFilesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def upsert_email_templates(self, email_templates: components.EmailTemplates, origin: components.Origin) -> operations.UpsertEmailTemplatesResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.UpsertEmailTemplatesRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.UpsertEmailTemplatesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def upsert_portal(self, upsert_portal_config: components.UpsertPortalConfig, origin: components.Origin) -> operations.UpsertPortalResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.UpsertPortalRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.UpsertPortalResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def upsert_portal_widget(self, upsert_portal_widget: components.UpsertPortalWidget, origin: components.Origin) -> operations.UpsertPortalWidgetResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.UpsertPortalWidgetRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.UpsertPortalWidgetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
