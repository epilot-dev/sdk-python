...
class FetchPortalUsersByRelatedEntityRequest(BaseModel):
    ...
    slug: Annotated[
        EntitySlug, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))
    ]
    r"""URL-friendly identifier for the entity schema"""
...
class FetchPortalUsersByRelatedEntityResponseBody(BaseModel):
    ...
    portal_users: Annotated[
        Optional[List[PortalUser]], pydantic.Field(alias="portalUsers")
    ] = None
