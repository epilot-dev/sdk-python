...
class GetAllContractsData(BaseModel):
    ...
    billing_period: Optional[GetAllContractsBillingPeriod] = (
        GetAllContractsBillingPeriod.WEEKLY
    )
    r"""The billing period associated with the contract."""
    ...
    notice_time_unit: Optional[GetAllContractsNoticeTimeUnit] = (
        GetAllContractsNoticeTimeUnit.MONTHS
    )
    r"""The unit of time for the notice period."""
    ...
    renewal_duration_unit: Optional[GetAllContractsRenewalDurationUnit] = (
        GetAllContractsRenewalDurationUnit.MONTHS
    )
    r"""The unit of time for the renewal period."""
