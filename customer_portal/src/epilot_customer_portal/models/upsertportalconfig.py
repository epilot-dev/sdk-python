...
from .extensionconfig import ExtensionConfig, ExtensionConfigTypedDict
...
class DefaultUserToNotify(BaseModel):
    ...
    on_pending_user: Annotated[
        Optional[List[AdminUser]], pydantic.Field(alias="onPendingUser")
    ] = None
    r"""Default admin users for pending user notification to notify"""
...
class EntityActions(BaseModel):
    action_label: Annotated[
        Optional[UpsertPortalConfigActionLabel], pydantic.Field(alias="action_Label")
    ] = None
...
class UpsertPortalConfigTriggerName(str, Enum):
    FIRST_LOGIN = "FIRST_LOGIN"
    ACCEPT_ORDER = "ACCEPT_ORDER"
    DECLINE_ORDER = "DECLINE_ORDER"


class UpsertPortalConfigTriggeredJourneysTypedDict(TypedDict):
    journey_id: NotRequired[str]
    r"""Entity ID"""
    trigger_name: NotRequired[UpsertPortalConfigTriggerName]


class UpsertPortalConfigTriggeredJourneys(BaseModel):
    journey_id: Optional[str] = None
    r"""Entity ID"""

    trigger_name: Optional[UpsertPortalConfigTriggerName] = None
...
class UpsertPortalConfigTypedDict(TypedDict):
    ...
    r"""Identifiers used to identify an entity by a portal user. Deprecated. Use contract_identifiers instead."""
    extension_hooks: NotRequired[Dict[str, ExtensionHookConfigTypedDict]]
    r"""Configured Portal extensions hooks"""
    extensions: NotRequired[List[ExtensionConfigTypedDict]]
    r"""Configured Portal extensions"""
    ...
    triggered_journeys: NotRequired[List[UpsertPortalConfigTriggeredJourneysTypedDict]]
...
class UpsertPortalConfig(BaseModel):
    ...
    entity_identifiers: Annotated[
        Optional[UpsertPortalConfigEntityIdentifiers],
        pydantic.Field(
            deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible."
        ),
    ] = None
    ...
    extension_hooks: Optional[Dict[str, ExtensionHookConfig]] = None
    r"""Configured Portal extensions hooks"""
    ...
    self_registration_setting: Optional[UpsertPortalConfigSelfRegistrationSetting] = (
        None
    )

    triggered_journeys: Optional[List[UpsertPortalConfigTriggeredJourneys]] = None
    r"""Journeys automatically opened on a portal user action"""
