...
class GetAllOpportunitiesRequestTypedDict(TypedDict):
    from_: NotRequired[float]
    size: NotRequired[float]
    

class GetAllOpportunitiesRequest(BaseModel):
...
class GetAllOpportunitiesSchema(str, Enum):
    OPPORTUNITY = "opportunity"

class GetAllOpportunitiesDataTypedDict(TypedDict):
    ...
    schema_: GetAllOpportunitiesSchema
    title: str
...
class GetAllOpportunitiesData(BaseModel):
    r"""The opportunity entity"""
    ...
    r"""Organization ID the entity belongs to"""
    schema_: Annotated[GetAllOpportunitiesSchema, pydantic.Field(alias="_schema")]
...
class GetAllOpportunitiesResponseBodyTypedDict(TypedDict):
    r"""The opportunities is retrieved successfully for the portal user."""
    
    data: NotRequired[List[GetAllOpportunitiesDataTypedDict]]
    

class GetAllOpportunitiesResponseBody(BaseModel):
    r"""The opportunities is retrieved successfully for the portal user."""
    
    data: Optional[List[GetAllOpportunitiesData]] = None
