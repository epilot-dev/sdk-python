...
class TriggeredJourneysTypedDict(TypedDict):
    journey_id: NotRequired[str]
    r"""Entity ID"""
    trigger_name: NotRequired[TriggerName]


class TriggeredJourneys(BaseModel):
    journey_id: Optional[str] = None
    r"""Entity ID"""

    trigger_name: Optional[TriggerName] = None
...
class PortalConfigTypedDict(TypedDict):
    ...
    triggered_journeys: NotRequired[List[TriggeredJourneysTypedDict]]
...
class PortalConfig(BaseModel):
    ...
    triggered_journeys: Optional[List[TriggeredJourneys]] = None
    r"""Journeys automatically opened on a portal user action"""
