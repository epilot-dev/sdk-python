...
class PortalConfig(BaseModel):
    ...
    r"""Rules for editing an entity by a portal user"""
    entity_identifiers: Annotated[Optional[EntityIdentifiers], pydantic.Field(deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.")] = None
    r"""Identifiers used to identify an entity by a portal user. Deprecated. Use contract_identifiers instead."""
