...
class SchemasContract(BaseModel):
    dollar_relation: Annotated[
        Optional[List[SchemasDollarRelation]], pydantic.Field(alias="$relation")
    ] = None


class SchemasReimbursementEventType(str, Enum):
...
class ReimbursementEventSchemasTypedDict(TypedDict):
    ...
    type: SchemasReimbursementEventType
    r"""Type of the billing event."""
...
class SchemasInstallmentEventContract(BaseModel):
    dollar_relation: Annotated[
        Optional[List[DollarRelation]], pydantic.Field(alias="$relation")
    ] = None


class SchemasInstallmentEventType(str, Enum):
    r"""Type of the billing event."""

    INSTALLMENT = "installment"


class InstallmentEventSchemasTypedDict(TypedDict):
    ...
    due_date: date
    r"""Date on which the installment is due."""
    type: SchemasInstallmentEventType
    r"""Type of the billing event."""
    tags: NotRequired[List[str]]
    r"""Array of entity tags"""
    billing_amount: NotRequired[int]
...
class InstallmentEventSchemas(BaseModel):
    r"""An entity that describes an installment billing event."""
...
BillingEventTypedDict = TypeAliasType(
    "BillingEventTypedDict",
    Union[InstallmentEventSchemasTypedDict, ReimbursementEventSchemasTypedDict],
)
r"""An entity that describes a billing event such as a future installment or a reimbursement back to the customer."""


BillingEvent = TypeAliasType(
    "BillingEvent", Union[InstallmentEventSchemas, ReimbursementEventSchemas]
)
r"""An entity that describes a billing event such as a future installment or a reimbursement back to the customer."""
