...
with Epilot(
    ...
    res = epilot.ecp.get_consumption(extension_id="<id>", from_=dateutil.parser.isoparse("2023-05-13T18:38:28.810Z"), hook_id="<id>", interval=epilot_customer_portal.Interval.P1_M, to=dateutil.parser.isoparse("2023-10-14T20:40:01.754Z"))
...
with Epilot(
    ...
    res = epilot.ecp.get_costs(extension_id="<id>", from_=dateutil.parser.isoparse("2022-02-07T07:43:34.088Z"), hook_id="<id>", interval=epilot_customer_portal.QueryParamInterval.P1_D, to=dateutil.parser.isoparse("2024-06-10T07:17:02.092Z"))
...
with Epilot(
    ...
    res = epilot.ecp.get_prices(extension_id="<id>", from_=dateutil.parser.isoparse("2022-07-16T08:39:13.009Z"), hook_id="<id>", interval=epilot_customer_portal.GetPricesQueryParamInterval.PT15_M, to=dateutil.parser.isoparse("2024-08-14T14:51:12.268Z"))
