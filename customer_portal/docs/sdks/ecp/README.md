...
with Epilot(
    ...
    res = epilot.ecp.create_meter_reading(meter_reading={
        "meter_id": "5da0a718-c822-403d-9f5d-20d4584e0528",
        "source": epilot_customer_portal.Source.ERP,
        "value": 240,
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `meter_reading`                                                     | [models.MeterReading](../../models/meterreading.md)                 | :heavy_check_mark:                                                  | Meter reading payload.                                              |
...
with Epilot(
    ...
    res = epilot.ecp.delete_entity_file(request={
...
with Epilot(
    ...
    res = epilot.ecp.get_billing_events(request={
        "entity_id": [
            "5da0a718-c822-403d-9f5d-20d4584e0528",
        ],
        "from_": 0,
...
with Epilot(
    ...
    res = epilot.ecp.get_consumption(request={
        "extension_id": "<id>",
        "from_": dateutil.parser.isoparse("2023-05-13T18:38:28.810Z"),
        "hook_id": "<id>",
        "interval": epilot_customer_portal.Interval.P1_M,
        "to": dateutil.parser.isoparse("2023-10-14T20:40:01.754Z"),
    })
...
| Parameter                                                             | Type                                                                  | Required                                                              | Description                                                           |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `request`                                                             | [models.GetConsumptionRequest](../../models/getconsumptionrequest.md) | :heavy_check_mark:                                                    | The request object to use for the request.                            |
| `retries`                                                             | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)      | :heavy_minus_sign:                                                    | Configuration to override the default retry behavior of the client.   |
...
with Epilot(
    ...
    res = epilot.ecp.get_costs(request={
        "extension_id": "<id>",
        "from_": dateutil.parser.isoparse("2022-02-07T07:43:34.088Z"),
        "hook_id": "<id>",
        "interval": epilot_customer_portal.QueryParamInterval.P1_D,
        "to": dateutil.parser.isoparse("2024-06-10T07:17:02.092Z"),
    })
...
| Parameter                                                           | Type                                                                | Required                                                            | Description                                                         |
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `request`                                                           | [models.GetCostsRequest](../../models/getcostsrequest.md)           | :heavy_check_mark:                                                  | The request object to use for the request.                          |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |

### Response

**[List[models.GetCostsResponseBody]](../../models/.md)**
...
with Epilot(
    ...
    res = epilot.ecp.get_prices(request={
        "extension_id": "<id>",
        "from_": dateutil.parser.isoparse("2022-07-16T08:39:13.009Z"),
        "hook_id": "<id>",
        "interval": epilot_customer_portal.GetPricesQueryParamInterval.PT15_M,
        "to": dateutil.parser.isoparse("2024-08-14T14:51:12.268Z"),
    })
...
**[List[models.GetPricesResponseBody]](../../models/.md)**
...
with Epilot(
    ...
    res = epilot.ecp.get_search_results_for_opportunities(request_body={
        "purposes": [
            "5da0a718-c822-403d-9f5d-20d4584e0528",
        ],
    }, from_=0, size=1000)
...
with Epilot(
    ...
    res = epilot.ecp.post_order_acceptance(id="5da0a718-c822-403d-9f5d-20d4584e0528")
...
with Epilot(
    ...
    res = epilot.ecp.revoke_token(request={
...
with Epilot(
    ...
    res = epilot.ecp.save_entity_file(request={
        "entity_id": "5da0a718-c822-403d-9f5d-20d4584e0528",
        "entity_type": "order",
        "files": [
            {
...
with Epilot(
    ...
    res = epilot.ecp.update_portal_user_email(request={
        "email": "john@doe.com",
        "password": "XPF599YfftQdi1n",
    })
