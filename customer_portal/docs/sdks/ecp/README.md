...
with Epilot(
    ...
    res = s.ecp.create_meter_reading(meter_reading={
...
with Epilot(
    ...
    res = s.ecp.get_consumption(request={
        "extension_id": "<id>",
...
with Epilot(
    ...
    res = s.ecp.get_resolved_external_link(id="5da0a718-c822-403d-9f5d-20d4584e0528", contact_id="5da0a718-c822-403d-9f5d-20d4584e0528")
