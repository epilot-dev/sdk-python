...
**[models.AddContractByIdentifiersECPResponseBody](../../models/addcontractbyidentifiersecpresponsebody.md)**

### Errors

| Error Type                                  | Status Code                                 | Content Type                                |
| ------------------------------------------- | ------------------------------------------- | ------------------------------------------- |
| models.ErrorRespError                       | 400, 401, 403, 500                          | application/json                            |
| models.AddContractByIdentifiersResponseBody | 409                                         | application/json                            |
...
| Error Type            | Status Code           | Content Type          |
| --------------------- | --------------------- | --------------------- |
| models.ErrorRespError | 401, 403, 500         | application/json      |
| models.SDKError       | 4XX, 5XX              | \*/\*                 |
...
| Error Type              | Status Code             | Content Type            |
| ----------------------- | ----------------------- | ----------------------- |
| models.ErrorRespError   | 400, 401, 403, 404, 500 | application/json        |
| models.SDKError         | 4XX, 5XX                | \*/\*                   |
...
| Error Type            | Status Code           | Content Type          |
| --------------------- | --------------------- | --------------------- |
| models.ErrorRespError | 401, 500              | application/json      |
| models.SDKError       | 4XX, 5XX              | \*/\*                 |
...
| Error Type            | Status Code           | Content Type          |
| --------------------- | --------------------- | --------------------- |
| models.ErrorRespError | 401, 403, 404, 500    | application/json      |
| models.SDKError       | 4XX, 5XX              | \*/\*                 |
...
| Error Type              | Status Code             | Content Type            |
| ----------------------- | ----------------------- | ----------------------- |
| models.ErrorRespError   | 401, 403, 404, 409, 500 | application/json        |
| models.SDKError         | 4XX, 5XX                | \*/\*                   |
...
**[models.UpdateContactECPResponseBody](../../models/updatecontactecpresponsebody.md)**

### Errors

| Error Type                       | Status Code                      | Content Type                     |
| -------------------------------- | -------------------------------- | -------------------------------- |
| models.ErrorRespError            | 401, 404, 500                    | application/json                 |
| models.UpdateContactResponseBody | 403                              | application/json                 |
| models.SDKError                  | 4XX, 5XX                         | \*/\*                            |
...
**[models.UpdateContractECPResponseBody](../../models/updatecontractecpresponsebody.md)**
...
| --------------------------------- | --------------------------------- | --------------------------------- |
| models.ErrorRespError             | 401, 404, 500                     | application/json                  |
| models.UpdateContractResponseBody | 403                               | application/json                  |
| models.SDKError                   | 4XX, 5XX                          | \*/\*                             |
