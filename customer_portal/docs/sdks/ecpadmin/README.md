...
res = s.ecp_admin.upsert_portal_widget(origin=epilot_customer_portal.Origin.END_CUSTOMER_PORTAL, upsert_portal_widget={
    "widgets": [
        {
            "id": "<id>",
            "list_index": 195954,
        ...
        },
        {
            "id": "<id>",
            "list_index": 961075,
            "type": epilot_customer_portal.TeaserWidgetType.CONTENT_WIDGET,
        },
    ],
})
