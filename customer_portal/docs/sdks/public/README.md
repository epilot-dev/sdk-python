...
with Epilot() as s:
    res = s.public.confirm_user(confirmation_link_token="<value>")
...
with Epilot() as s:
    res = s.public.get_public_portal_extension_details(org_id="12324", origin=epilot_customer_portal.Origin.INSTALLER_PORTAL)
...
**[models.PublicExtension](../../models/publicextension.md)**
