...
with Epilot() as epilot:
    ...
    res = epilot.public.check_contact_exists(origin=epilot_customer_portal.Origin.END_CUSTOMER_PORTAL, contact_exists_request={
        "org_id": "728",
...
with Epilot() as epilot:
    ...
    res = epilot.public.create_user(origin=epilot_customer_portal.Origin.INSTALLER_PORTAL, create_user_request={
