...
res = s.public.confirm_user(id='5da0a718-c822-403d-9f5d-20d4584e0528', org_id='123', origin=shared.Origin.INSTALLER_PORTAL)
...
res = s.public.create_user(create_user_request=shared.CreateUserRequest(
    contact_id='123456',
    contact_identifiers={
        "key": 'string',
    },
...
res = s.public.get_contact_count(contact_count_request=shared.ContactCountRequest(
    contact_identifiers={
        "key": 'string',
    },
    org_id='728',
...
res = s.public.get_public_portal_config(org_id='12324', origin=shared.Origin.INSTALLER_PORTAL)
...
res = s.public.get_public_portal_widgets(org_id='123', origin=shared.Origin.END_CUSTOMER_PORTAL)
...
res = s.public.user_exists(email='user@example.com', org_id='123', origin=shared.Origin.END_CUSTOMER_PORTAL)
