...
with Epilot(
    ...
    res = epilot.activity.get_entity_activity_feed(id="5da0a718-c822-403d-9f5d-20d4584e0528", slug=epilot_customer_portal.EntitySlug.CONTACT, type_="SyncActivity")
