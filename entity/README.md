...
* [get_es_public_jwks](docs/sdks/public/README.md#get_es_public_jwks) - getESPublicJwks
* [get_es_token_oidc](docs/sdks/public/README.md#get_es_token_oidc) - getESTokenOIDC
...
try:
    ...
    # handle e.data: models.EntityValidationResultErrorData
    raise(e)
