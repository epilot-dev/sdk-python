...
* [patch_saved_view](docs/sdks/savedviews/README.md#patch_saved_view) - patchSavedView
...
* [get_taxonomy_bulk_action_job_by_id](docs/sdks/taxonomysdk/README.md#get_taxonomy_bulk_action_job_by_id) - getTaxonomyBulkActionJobById
* [get_taxonomy_bulk_action_jobs](docs/sdks/taxonomysdk/README.md#get_taxonomy_bulk_action_jobs) - getTaxonomyBulkActionJobs
...
with Epilot(
    ...
    except models.AttachActivityResponseBody as e:
        # handle e.data: models.AttachActivityResponseBodyData
        raise(e)
...
import epilot_entity
from epilot_entity import Epilot
from epilot_entity.utils import BackoffStrategy, RetryConfig
