...
### `models.AddressRelationAttributeSchemasModelInput`

```python
value: models.AddressRelationAttributeSchemasModelInput = /* values here */
```
...
### `models.MessageEmailAddressAttributeSchemasModelInput`

```python
value: models.MessageEmailAddressAttributeSchemasModelInput = /* values here */
```
