...
### `models.AddressAttribute`

```python
value: models.AddressAttribute = /* values here */
```
...
### `models.MessageEmailAddressAttribute`

```python
value: models.MessageEmailAddressAttribute = /* values here */
```
