...
### `models.AddressRelationAttributeSchemasModel`

```python
value: models.AddressRelationAttributeSchemasModel = /* values here */
```
...
### `models.MessageEmailAddressAttributeSchemasModel`

```python
value: models.MessageEmailAddressAttributeSchemasModel = /* values here */
```
