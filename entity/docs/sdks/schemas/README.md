...
| Error Type                   | Status Code                  | Content Type                 |
| ---------------------------- | ---------------------------- | ---------------------------- |
| models.GetSchemaResponseBody | 404                          | application/json             |
| models.SDKError              | 4XX, 5XX                     | \*/\*                        |
...
| Error Type                            | Status Code                           | Content Type                          |
| ------------------------------------- | ------------------------------------- | ------------------------------------- |
| models.GetSchemaAttributeResponseBody | 404                                   | application/json                      |
| models.SDKError                       | 4XX, 5XX                              | \*/\*                                 |
...
| Error Type                             | Status Code                            | Content Type                           |
| -------------------------------------- | -------------------------------------- | -------------------------------------- |
| models.GetSchemaCapabilityResponseBody | 404                                    | application/json                       |
| models.SDKError                        | 4XX, 5XX                               | \*/\*                                  |
...
| Error Type                        | Status Code                       | Content Type                      |
| --------------------------------- | --------------------------------- | --------------------------------- |
| models.GetSchemaGroupResponseBody | 404                               | application/json                  |
| models.SDKError                   | 4XX, 5XX                          | \*/\*                             |
...
| Error Type                                | Status Code                               | Content Type                              |
| ----------------------------------------- | ----------------------------------------- | ----------------------------------------- |
| models.GetSchemaGroupHeadlineResponseBody | 404                                       | application/json                          |
| models.SDKError                           | 4XX, 5XX                                  | \*/\*                                     |
...
with Epilot(
    ...
    res = epilot.schemas.list_schemas(request={
        "unpublished": False,
    })
                    ...
                    "attributes": [
                        {
                            ...
                            "label": "<value>",
                            "name": "<value>",
                            "type": epilot_entity.CurrencyAttributeType.CURRENCY,
                            "manifest": [
                                "123e4567-e89b-12d3-a456-426614174000",
                            ],
                            "purpose": [
