...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| models.GetSavedViewResponseBody | 404                             | application/json                |
| models.SDKError                 | 4XX, 5XX                        | \*/\*                           |
...
with Epilot(
    ...
    res = epilot.saved_views.update_saved_view(request=epilot_entity.UpdateSavedViewRequest(
        id="002d716d-5b81-47ee-a0ca-3f6b7849863c",
        saved_view_item=epilot_entity.SavedViewItem(
            created_by={
                "user_id": "10598",
            },
            name="View listing German",
