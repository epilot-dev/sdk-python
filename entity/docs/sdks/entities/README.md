...
with Epilot(
    ...
    res = epilot.entities.create_entity(request={
        "slug": "contact",
...
with Epilot(
    ...
    res = epilot.entities.patch_entity(request={
        "entity": epilot_entity.EntityInput(
            **{
...
with Epilot(
    ...
    res = epilot.entities.update_entity(request={
...
with Epilot(
    ...
    res = epilot.entities.upsert_entity(request={
        "slug": "contact",
        "request_body": {
            "entity": epilot_entity.EntityInput(
...
with Epilot(
    ...
    res = epilot.entities.validate_entity(request={
        "slug": "contact",
        "entity": epilot_entity.EntityInput(
            **{
...
with Epilot(
    ...
    res = epilot.entities.validate_entity_v2(request={
        "slug": "price",
        "entity": epilot_entity.EntityInput(
            **{
                "code": "MODEL_375KW_PREMIUM",
