...
| Error Type                     | Status Code                    | Content Type                   |
| ------------------------------ | ------------------------------ | ------------------------------ |
| models.GetTaxonomyResponseBody | 404                            | application/json               |
| models.SDKError                | 4XX, 5XX                       | \*/\*                          |
...
with Epilot(
    ...
    res = epilot.taxonomy.get_taxonomy_bulk_action_jobs(request={
        "size": 20,
    })
...
| Error Type                                   | Status Code                                  | Content Type                                 |
| -------------------------------------------- | -------------------------------------------- | -------------------------------------------- |
| models.GetTaxonomyClassificationResponseBody | 404                                          | application/json                             |
| models.SDKError                              | 4XX, 5XX                                     | \*/\*                                        |
...
with Epilot(
    ...
    res = epilot.taxonomy.list_taxonomies(request={
...
| Error Type                                                  | Status Code                                                 | Content Type                                                |
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| models.UpdateClassificationsForTaxonomyTaxonomyResponseBody | 404                                                         | application/json                                            |
| models.SDKError                                             | 4XX, 5XX                                                    | \*/\*                                                       |
