...
class Export(BaseSDK):
    ...
    def export_entities(
        self, *,
        request: Optional[Union[models.ExportEntitiesRequest, models.ExportEntitiesRequestTypedDict]] = None,
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.entity_search_params, False, True, "json", Optional[models.EntitySearchParams]),
