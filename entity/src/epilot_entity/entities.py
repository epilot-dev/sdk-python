...
class Entities(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.AutocompleteResponseBody]
            )
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.entity, False, True, "json", Optional[models.EntityInput]
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.EntityValidationV2ResultErrorData
            )
            raise models.EntityValidationV2ResultError(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get_entity(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.GetEntityResponseBody]
            )
        if utils.match_response(http_res, "404", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.GetEntityEntitiesResponseBodyData
            )
            raise models.GetEntityEntitiesResponseBody(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get_entity_v2(
        ...
        *,
        ...
        if utils.match_response(http_res, "404", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.GetEntityV2ResponseBodyData
            )
            raise models.GetEntityV2ResponseBody(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_entities(
        ...
        *,
        request: Optional[
            Union[models.EntityListParams, models.EntityListParamsTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.EntityListParams])
        request = cast(Optional[models.EntityListParams], request)
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.EntityListParams]
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.EntitySearchResults]
            )
    ...
    def patch_entity(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.entity, False, False, "json", models.EntityInput
            ),
            timeout_ms=timeout_ms,
        )
    ...
    def restore_entity(
        ...
        *,
        request: Union[
            models.RestoreEntityRequest, models.RestoreEntityRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.RestoreEntityRequest)
        request = cast(models.RestoreEntityRequest, request)

        req = self._build_request(
            method="PATCH",
            path="/v1/entity/{slug}/{id}:restore",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.RestoreEntityRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
    ...
    async def restore_entity_async(
        self,
        *,
        request: Union[
            models.RestoreEntityRequest, models.RestoreEntityRequestTypedDict
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.UpsertEntityRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="upsertEntity",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
            error_status_codes=["405", "409", "422", "4XX", "5XX"],
            retry_config=retry_config,
        )
        ...
        if utils.match_response(http_res, ["200", "201"], "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.EntityItem])
        if utils.match_response(http_res, ["405", "409", "4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
            )
    ...
    def validate_entity(
        ...
        *,
        request: Union[
            models.ValidateEntityRequest, models.ValidateEntityRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.EntityValidationResultSuccess]
            )
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.EntityValidationResultErrorData
            )
    ...
    def validate_entity_v2(
        ...
        *,
        request: Union[
            models.ValidateEntityV2Request, models.ValidateEntityV2RequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.EntityValidationV2ResultSuccess]:
        r"""validateEntityV2
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ValidateEntityV2Request)
        request = cast(models.ValidateEntityV2Request, request)

        req = self._build_request(
            method="POST",
            path="/v2/entity/{slug}:validate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.EntityValidationV2ResultSuccess]
            )
        if utils.match_response(http_res, "422", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, models.EntityValidationV2ResultErrorData
    ...
    async def validate_entity_v2_async(
        self,
        *,
        request: Union[
            models.ValidateEntityV2Request, models.ValidateEntityV2RequestTypedDict
