...
class GetRelationsV3Request(BaseModel):
    ...
    *It gets overriden by mode query parameter.*
    ...
    mode: Annotated[
        Optional[EntityRelationsModeQueryParam],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Options to determine how relations will be included in the result.
    *It overrides the include_reverse query param.*
...
class GetRelationsV3ResponseBodyData(BaseModel):
...
class GetRelationsV3ResponseBody(Exception):
    r"""A generic error returned by the API"""

    data: GetRelationsV3ResponseBodyData

    def __init__(self, data: GetRelationsV3ResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetRelationsV3ResponseBodyData)
