...
class AddressAttributeConstraintsTypedDict(TypedDict):
...
class AddressAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class AddressAttributeDefaultAddressFields(str, Enum):
...
class AddressAttributeInfoHelpersTypedDict(TypedDict):
...
class AddressAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class AddressAttributeType(str, Enum):
    ADDRESS = "address"


class AddressAttributeTypedDict(TypedDict):
    r"""Address attribute"""
    ...
    constraints: NotRequired[AddressAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.

    """
    default_address_fields: NotRequired[List[AddressAttributeDefaultAddressFields]]
    ...
    info_helpers: NotRequired[AddressAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: NotRequired[AddressAttributeType]
...
class AddressAttribute(BaseModel):
    ...
    constraints: Optional[AddressAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.

    """

    default_address_fields: Optional[List[AddressAttributeDefaultAddressFields]] = None
    r"""Default fields visible on addresses"""
    ...
    info_helpers: Optional[AddressAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: Optional[AddressAttributeType] = None
