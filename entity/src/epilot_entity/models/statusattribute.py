...
class StatusAttributeConstraintsTypedDict(TypedDict):
...
class StatusAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class StatusAttributeInfoHelpersTypedDict(TypedDict):
...
class StatusAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class StatusAttribute2TypedDict(TypedDict):
    value: str
...
class StatusAttribute2(BaseModel):
    value: str
    r"""The stored value of the option"""
...
StatusAttributeOptionsTypedDict = TypeAliasType(
    "StatusAttributeOptionsTypedDict", Union[StatusAttribute2TypedDict, str]
)


StatusAttributeOptions = TypeAliasType(
    "StatusAttributeOptions", Union[StatusAttribute2, str]
)
...
class StatusAttributeTypedDict(TypedDict):
    r"""Status select"""
    ...
    constraints: NotRequired[StatusAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[StatusAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    layout: NotRequired[str]
    options: NotRequired[List[StatusAttributeOptionsTypedDict]]
    ...
    type: NotRequired[StatusAttributeType]
...
class StatusAttribute(BaseModel):
    ...
    constraints: Optional[StatusAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[StatusAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""

    layout: Optional[str] = None

    options: Optional[List[StatusAttributeOptions]] = None
    ...
    type: Optional[StatusAttributeType] = None
