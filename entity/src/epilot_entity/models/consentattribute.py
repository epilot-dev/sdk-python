...
class ConsentAttributeConstraintsTypedDict(TypedDict):
...
class ConsentAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class ConsentAttributeInfoHelpersTypedDict(TypedDict):
...
class ConsentAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class ConsentAttributeTypedDict(TypedDict):
    r"""Consent Management"""

    label: str
    name: str
    topic: str
    type: ConsentAttributeType
    ...
    constraints: NotRequired[ConsentAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[ConsentAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class ConsentAttribute(BaseModel):
    r"""Consent Management"""
    ...
    constraints: Optional[ConsentAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[ConsentAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
