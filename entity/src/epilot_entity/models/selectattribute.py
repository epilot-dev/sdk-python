...
class SelectAttributeConstraintsTypedDict(TypedDict):
...
class SelectAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class SelectAttributeInfoHelpersTypedDict(TypedDict):
...
class SelectAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class SelectAttribute1TypedDict(TypedDict):
    value: str
    title: NotRequired[str]


class SelectAttribute1(BaseModel):
    value: str

    title: Optional[str] = None


SelectAttributeOptionsTypedDict = TypeAliasType(
    "SelectAttributeOptionsTypedDict", Union[SelectAttribute1TypedDict, str]
)


SelectAttributeOptions = TypeAliasType(
    "SelectAttributeOptions", Union[SelectAttribute1, str]
)
...
class SelectAttributeTypedDict(TypedDict):
    r"""Dropdown select"""
    ...
    constraints: NotRequired[SelectAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[SelectAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    layout: NotRequired[str]
    options: NotRequired[List[SelectAttributeOptionsTypedDict]]
    ...
    type: NotRequired[SelectAttributeType]
...
class SelectAttribute(BaseModel):
    ...
    constraints: Optional[SelectAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[SelectAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""

    layout: Optional[str] = None

    options: Optional[List[SelectAttributeOptions]] = None
    ...
    type: Optional[SelectAttributeType] = None
