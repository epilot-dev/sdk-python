...
class GetRelationsV2ResponseBodyData(BaseModel):
...
class GetRelationsV2ResponseBody(Exception):
    r"""A generic error returned by the API"""

    data: GetRelationsV2ResponseBodyData

    def __init__(self, data: GetRelationsV2ResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetRelationsV2ResponseBodyData)
