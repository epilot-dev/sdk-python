...
class TagsAttributeConstraintsTypedDict(TypedDict):
...
class TagsAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class TagsAttributeInfoHelpersTypedDict(TypedDict):
...
class TagsAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class TagsAttributeTypedDict(TypedDict):
    r"""Tags"""
    ...
    constraints: NotRequired[TagsAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[TagsAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: NotRequired[TagsAttributeType]
    value_formatter: NotRequired[str]


class TagsAttribute(BaseModel):
    r"""Tags"""
    ...
    constraints: Optional[TagsAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[TagsAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: Optional[TagsAttributeType] = None
