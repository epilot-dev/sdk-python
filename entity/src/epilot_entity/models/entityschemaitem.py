...
class EntitySchemaItemCategory(str, Enum):
...
EntitySchemaItemCreateViewTypedDict = Union[
...
EntitySchemaItemCreateView = Union[
    EntityViewDisabled, EntityDefaultCreate, RedirectEntityView
]


EntitySchemaItemEditViewTypedDict = Union[
    EntityViewDisabledTypedDict, RedirectEntityViewTypedDict, EntityDefaultEditTypedDict
]


EntitySchemaItemEditView = Union[
    EntityViewDisabled, RedirectEntityView, EntityDefaultEdit
]
...
EntitySchemaItemSingleViewTypedDict = Union[
    EntityViewDisabledTypedDict, RedirectEntityViewTypedDict, EntityDefaultEditTypedDict
]


EntitySchemaItemSingleView = Union[
    EntityViewDisabled, RedirectEntityView, EntityDefaultEdit
]


EntitySchemaItemTableViewTypedDict = Union[
    EntityViewDisabledTypedDict,
    RedirectEntityViewTypedDict,
...
EntitySchemaItemTableView = Union[
    EntityViewDisabled, RedirectEntityView, EntityDefaultTable
]
...
class EntitySchemaItemTypedDict(TypedDict):
    ...
    category: NotRequired[EntitySchemaItemCategory]
...
class EntitySchemaItem(BaseModel):
    ...
    category: Optional[EntitySchemaItemCategory] = None
