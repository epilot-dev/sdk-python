...
CreateViewTypedDict = TypeAliasType(
    "CreateViewTypedDict",
    Union[
...
EditView = TypeAliasType(
    "EditView", Union[EntityViewDisabled, RedirectEntityView, EntityDefaultEdit]
)


SummaryAttributesTypedDict = TypeAliasType(
    "SummaryAttributesTypedDict", Union[SummaryAttributeTypedDict, str]
)


SummaryAttributes = TypeAliasType("SummaryAttributes", Union[SummaryAttribute, str])
...
class EntitySchemaUIConfigTypedDict(TypedDict):
    content_direction: NotRequired[ContentDirection]
    r"""Show attributes in a row or column"""


class EntitySchemaUIConfig(BaseModel):
    content_direction: Optional[ContentDirection] = None
    r"""Show attributes in a row or column"""
...
class ListItemTypedDict(TypedDict):
    ...
    ui_config: NotRequired[EntitySchemaUIConfigTypedDict]
...
class ListItem(BaseModel):
    ...
    ui_config: Optional[EntitySchemaUIConfig] = None
...
SingleViewTypedDict = TypeAliasType(
    "SingleViewTypedDict",
    Union[
        EntityViewDisabledTypedDict,
        RedirectEntityViewTypedDict,
