...
class SearchFilter(BaseModel):
    dollar_and: Annotated[
        Optional[List[SearchFilter]], pydantic.Field(alias="$and")
    ] = None
    r"""A subset of simplified Elasticsearch query clauses. The default operator is a logical AND. Use nested $and, $or, $not to combine filters using different logical operators."""

    dollar_not: Annotated[
        Optional[List[SearchFilter]], pydantic.Field(alias="$not")
    ] = None
    r"""A subset of simplified Elasticsearch query clauses. The default operator is a logical AND. Use nested $and, $or, $not to combine filters using different logical operators."""

    dollar_or: Annotated[Optional[List[SearchFilter]], pydantic.Field(alias="$or")] = (
        None
    )
    r"""A subset of simplified Elasticsearch query clauses. The default operator is a logical AND. Use nested $and, $or, $not to combine filters using different logical operators."""
