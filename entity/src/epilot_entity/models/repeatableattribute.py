...
class RepeatableAttributeConstraintsTypedDict(TypedDict):
...
class RepeatableAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class RepeatableAttributeInfoHelpersTypedDict(TypedDict):
...
class RepeatableAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class RepeatableAttributeTypedDict(TypedDict):
    ...
    constraints: NotRequired[RepeatableAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[RepeatableAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    relation_affinity_mode: NotRequired[RepeatableAttributeRelationAffinityMode]
    r"""Weak repeatable attributes are kept when duplicating an entity. Strong repeatable attributes are discarded when duplicating an entity."""
    ...
    type: NotRequired[RepeatableAttributeType]
    value_formatter: NotRequired[str]


class RepeatableAttribute(BaseModel):
    r"""Repeatable (add N number of fields)"""
    ...
    constraints: Optional[RepeatableAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[RepeatableAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    relation_affinity_mode: Optional[RepeatableAttributeRelationAffinityMode] = None
    r"""Weak repeatable attributes are kept when duplicating an entity. Strong repeatable attributes are discarded when duplicating an entity."""
    ...
    type: Optional[RepeatableAttributeType] = None
