...
AutocompleteResultsTypedDict = TypeAliasType(
    "AutocompleteResultsTypedDict", Union[str, bool, Dict[str, Any]]
)


AutocompleteResults = TypeAliasType(
    "AutocompleteResults", Union[str, bool, Dict[str, Any]]
)
...
class AutocompleteResponseBodyTypedDict(TypedDict):
    ...
    results: NotRequired[List[AutocompleteResultsTypedDict]]
...
class AutocompleteResponseBody(BaseModel):
    ...
    results: Optional[List[AutocompleteResults]] = None
