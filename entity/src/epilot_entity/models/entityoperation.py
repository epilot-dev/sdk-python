...
class DiffTypedDict(TypedDict):
    added: NotRequired[EntityTypedDict]
    deleted: NotRequired[EntityTypedDict]
    updated: NotRequired[EntityTypedDict]


class Diff(BaseModel):
    added: Optional[Entity] = None

    deleted: Optional[Entity] = None

    updated: Optional[Entity] = None
...
class Payload(BaseModel):
    ...
    created_at: Annotated[
        OptionalNullable[datetime], pydantic.Field(alias="_created_at")
    ] = UNSET
    ...
    updated_at: Annotated[
        OptionalNullable[datetime], pydantic.Field(alias="_updated_at")
    ] = UNSET
