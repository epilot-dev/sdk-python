...
class GetSchemaExampleRequestTypedDict(TypedDict):
    slug: str
    r"""Entity Type"""
    

class GetSchemaExampleRequest(BaseModel):
    slug: Annotated[str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    r"""Entity Type"""
    

class GetSchemaExampleResponseBodyTypedDict(TypedDict):
    r"""Success"""
    
    

class GetSchemaExampleResponseBody(BaseModel):
    r"""Success"""
