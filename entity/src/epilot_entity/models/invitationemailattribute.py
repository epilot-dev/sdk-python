...
class InvitationEmailAttributeConstraintsTypedDict(TypedDict):
...
class InvitationEmailAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class InvitationEmailAttributeInfoHelpersTypedDict(TypedDict):
...
class InvitationEmailAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class InvitationEmailAttributeTypedDict(TypedDict):
    ...
    constraints: NotRequired[InvitationEmailAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[InvitationEmailAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: NotRequired[InvitationEmailAttributeType]
    value_formatter: NotRequired[str]


class InvitationEmailAttribute(BaseModel):
    r"""Email address for send invitation"""
    ...
    constraints: Optional[InvitationEmailAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[InvitationEmailAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
    ...
    type: Optional[InvitationEmailAttributeType] = None
