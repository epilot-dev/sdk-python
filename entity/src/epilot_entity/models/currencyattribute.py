...
class CurrencyAttributeConstraintsTypedDict(TypedDict):
...
class CurrencyAttributeConstraints(BaseModel):
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
...
class CurrencyAttribute1TypedDict(TypedDict):
...
class CurrencyAttribute1(BaseModel):
    r"""A currency configuration"""
...
CurrencyAttributeCurrencyTypedDict = CurrencyAttribute1TypedDict


CurrencyAttributeCurrency = CurrencyAttribute1


class CurrencyAttributeInfoHelpersTypedDict(TypedDict):
...
class CurrencyAttributeInfoHelpers(BaseModel):
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class CurrencyAttributeTypedDict(TypedDict):
    r"""Currency input"""

    currency: List[CurrencyAttributeCurrencyTypedDict]
    ...
    constraints: NotRequired[CurrencyAttributeConstraintsTypedDict]
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: NotRequired[CurrencyAttributeInfoHelpersTypedDict]
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
...
class CurrencyAttribute(BaseModel):
    r"""Currency input"""
    ...
    constraints: Optional[CurrencyAttributeConstraints] = None
    r"""A set of constraints applicable to the attribute.
    These constraints should and will be enforced by the attribute renderer.
    ...
    info_helpers: Optional[CurrencyAttributeInfoHelpers] = None
    r"""A set of configurations meant to document and assist the user in filling the attribute."""
