...
class Entities:
    ...
    def get_entity_v2(self, id: str, slug: str, fields: Optional[List[str]] = None, hydrate: Optional[bool] = None) -> operations.GetEntityV2Response:
        ...
        headers = {}
        query_params = utils.get_query_params(operations.GetEntityV2Request, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.GetEntityV2Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def validate_entity(self, slug: str, entity: Optional[components.Entity] = None) -> operations.ValidateEntityResponse:
        ...
        res = operations.ValidateEntityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
