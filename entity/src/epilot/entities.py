...
class Entities:
    ...
    def create_entity(self, slug: str, entity: Optional[shared.Entity] = None, activity_id: Optional[str] = None, async_: Optional[bool] = None) -> operations.CreateEntityResponse:
        r"""createEntity
