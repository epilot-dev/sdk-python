...
class Entities:
    ...
    def autocomplete(self, attribute: str, input: Optional[str] = None, size: Optional[int] = None, slug: Optional[str] = None) -> operations.AutocompleteResponse:
        ...
        query_params = { **utils.get_query_params(operations.AutocompleteRequest, request), **query_params }
        ...
        res = operations.AutocompleteResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def create_entity(self, slug: str, entity: Optional[components.Entity] = None, activity_id: Optional[str] = None, async_: Optional[bool] = None) -> operations.CreateEntityResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.CreateEntityRequest, "entity", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(operations.CreateEntityRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.CreateEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def delete_entity(self, id: str, slug: str, activity_id: Optional[str] = None) -> operations.DeleteEntityResponse:
        ...
        query_params = { **utils.get_query_params(operations.DeleteEntityRequest, request), **query_params }
        headers['Accept'] = '*/*'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.DeleteEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get_entity(self, id: str, slug: str, hydrate: Optional[bool] = None) -> operations.GetEntityResponse:
        ...
        query_params = { **utils.get_query_params(operations.GetEntityRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.GetEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get_entity_v2(self, id: str, slug: str, fields: Optional[List[str]] = None, hydrate: Optional[bool] = None) -> operations.GetEntityV2Response:
        r"""getEntityV2
        Gets Entity by id.
        ...
        request = operations.GetEntityV2Request(
            id=id,
            slug=slug,
            fields=fields,
            hydrate=hydrate,
        ...
        url = utils.generate_url(operations.GetEntityV2Request, base_url, '/v2/entity/{slug}/{id}', request)
        ...
        query_params = { **utils.get_query_params(operations.GetEntityV2Request, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.GetEntityV2Response(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def patch_entity(self, request: operations.PatchEntityRequest) -> operations.PatchEntityResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.PatchEntityRequest, "entity", False, False, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.PatchEntityRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.PatchEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def search_entities(self, request: Optional[components.EntitySearchParams], accept_header_override: Optional[SearchEntitiesAcceptEnum] = None) -> operations.SearchEntitiesResponse:
        r"""searchEntities
        ...
        res = operations.SearchEntitiesResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update_entity(self, request: operations.UpdateEntityRequest) -> operations.UpdateEntityResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateEntityRequest, "entity", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(operations.UpdateEntityRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.UpdateEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def upsert_entity(self, request: operations.UpsertEntityRequest) -> operations.UpsertEntityResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpsertEntityRequest, "request_body", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = { **utils.get_query_params(operations.UpsertEntityRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.UpsertEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def validate_entity(self, slug: str, entity: Optional[components.Entity] = None) -> operations.ValidateEntityResponse:
        r"""validateEntity
        ...
        request = operations.ValidateEntityRequest(
            slug=slug,
            entity=entity,
        )
        ...
        url = utils.generate_url(operations.ValidateEntityRequest, base_url, '/v1/entity/{slug}:validate', request)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.ValidateEntityRequest, "entity", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.ValidateEntityResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[components.EntityValidationResultSuccess])
                res.entity_validation_result_success = out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
        elif http_res.status_code == 422:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, errors.EntityValidationResultError)
                raise out
            else:
                content_type = http_res.headers.get('Content-Type')
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
