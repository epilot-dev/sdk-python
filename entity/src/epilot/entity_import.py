...
class EntityImport:
    ...
    def import_entities(self, entity_import_params: Optional[components.EntityImportParams] = None, job_id: Optional[str] = None) -> operations.ImportEntitiesResponse:
        ...
        query_params = { **utils.get_query_params(operations.ImportEntitiesRequest, request), **query_params }
        headers['Accept'] = '*/*'
        ...
        res = operations.ImportEntitiesResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
