...
class InvitationEmailAttribute:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='invitation_email', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
