...
class PartnerStatusAttribute:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='partner_status', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
