...
class OrderedListAttribute:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='ordered_list', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
