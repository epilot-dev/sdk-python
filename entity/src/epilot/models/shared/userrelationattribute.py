...
class UserRelationAttribute:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='relation_user', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
