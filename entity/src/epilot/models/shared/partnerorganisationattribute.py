...
class PartnerOrganisationAttribute:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='partner_organisation', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
