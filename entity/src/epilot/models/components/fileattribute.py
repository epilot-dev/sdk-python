...
class FileAttribute:
    ...
    These constraints should and will be enforced by the attribute renderer.
    """
    default_access_control: Optional[DefaultAccessControl] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_access_control'), 'exclude': lambda f: f is None }})
