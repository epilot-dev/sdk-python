...
class EntitySchemaItemInfoTooltipTitle:
...
class EntitySchemaItemGroupSettings:
    ...
    info_tooltip_title: Optional[EntitySchemaItemInfoTooltipTitle] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('info_tooltip_title'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class EntitySchemaItemListItem:
...
class EntitySchemaItemUIConfig:
    ...
    list_item: Optional[EntitySchemaItemListItem] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list_item'), 'exclude': lambda f: f is None }})
    sharing: Optional[EntitySchemaItemSharing] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sharing'), 'exclude': lambda f: f is None }})
