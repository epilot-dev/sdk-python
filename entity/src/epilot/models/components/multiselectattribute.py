...
class MultiSelectAttribute:
    ...
    allow_extra_options: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('allow_extra_options'), 'exclude': lambda f: f is MultiSelectAttribute.UNSET }})
    ...
    disable_case_sensitive: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('disable_case_sensitive'), 'exclude': lambda f: f is MultiSelectAttribute.UNSET }})
    ...
    options: Optional[List[Union[str, Two]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
