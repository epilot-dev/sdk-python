...
class PriceItem:
    ...
    price: Optional[PriceItemPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_price'), 'exclude': lambda f: f is None }})
    ...
    recurrences: Optional[List[PriceItemRecurrences]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recurrences'), 'exclude': lambda f: f is None }})
    r"""The sum of amounts of the price items by recurrence."""
    taxes: Optional[List[PriceItemTaxes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxes'), 'exclude': lambda f: f is None }})
...
PriceItemPrice = Union[Price, CompositePrice]

PriceItemRecurrences = Union[RecurrenceAmount]

PriceItemTaxes = Union[TaxAmount]
