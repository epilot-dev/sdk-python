...
from .priceitemsdto import PriceItemsDto
...
class CartDto:
    ...
    line_items: List[PriceItemsDto] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('line_items') }})
