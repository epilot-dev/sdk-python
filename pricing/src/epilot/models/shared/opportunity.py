...
class DeliveryAddress:
    ...
    dollar_relation_ref: Optional[List[Union[OpportunitySchemasDeliveryAddress1]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('$relation_ref'), 'exclude': lambda f: f is None }})
    r"""The relation from which a field is being referenced"""
