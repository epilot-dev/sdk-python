...
class CatalogAPI(BaseSDK):
        ...
        *,
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.CatalogSearch
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="$privateSearchCatalog",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.CatalogSearchResult)
    ...
    def dollar_search_catalog(
        ...
        *,
        ...
        security: Optional[
            Union[
                models.DollarSearchCatalogSecurity,
                models.DollarSearchCatalogSecurityTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.DollarSearchCatalogRequest(
            ...
            catalog_search=utils.get_pydantic_model(
                catalog_search, models.CatalogSearch
            ),
        )
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.DollarSearchCatalogSecurity]
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.catalog_search, False, False, "json", models.CatalogSearch
            ),
            timeout_ms=timeout_ms,
        )
