...
class CartAPI(BaseSDK):
    ...
    def dollar_checkout_cart(
        ...
        *,
        ...
        security: Optional[
            Union[
                models.DollarCheckoutCartSecurity,
                models.DollarCheckoutCartSecurityTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.CheckoutCartResult:
        r"""checkoutCart
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.DollarCheckoutCartSecurity]
            ),
            get_serialized_body=lambda: utils.serialize_request_body(
                request.checkout_cart, False, False, "json", models.CheckoutCart
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="$checkoutCart", oauth2_scopes=[], security_source=security
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.CheckoutCartResult)
