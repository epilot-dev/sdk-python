...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ |
| `request`                                                          | [components.OrderPayload](../../models/components/orderpayload.md) | :heavy_check_mark:                                                 | The request object to use for the request.                         |
...
res = s.order_api.put_order(order_payload=components.OrderPayload(
    billing_address=[
        components.Address(
            tags=[
                '<value>',
...
), id='9d4602d3-03be-4d85-86b2-f3c6555fc606')
