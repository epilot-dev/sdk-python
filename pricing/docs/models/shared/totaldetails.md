...
| `breakdown`                                                                   | [Optional[shared.Breakdown]](../../models/shared/breakdown.md)                | :heavy_minus_sign:                                                            | Breakdown of individual tax (and discount) amounts that add up to the totals. |