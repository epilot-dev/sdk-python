...
with Epilot(
    ...
    res = epilot.partners.approve_partner(id="e45a6dc2-3795-43a3-ae0f-6b6760f310fc")
...
with Epilot(
    ...
    res = epilot.partners.batch_get_assignable()
...
with Epilot() as epilot:
    ...
    res = epilot.partners.get_partner_by_token(token="<value>")
...
with Epilot(
    ...
    res = epilot.partners.invite_partner_v2(id="e45a6dc2-3795-43a3-ae0f-6b6760f310fc")
...
with Epilot(
    ...
    res = epilot.partners.reject_partner(id="e45a6dc2-3795-43a3-ae0f-6b6760f310fc")
...
with Epilot(
    ...
    res = epilot.partners.search_assignable(request={
        "from_": 0,
        "org_ids": [
            "123",
        ],
        "portal_users_entity_id_scope": "",
        "q": "",
        "size": 25,
    })
...
with Epilot(
    ...
    res = epilot.partners.search_geolocation_for_text(request={
