...
class Step(BaseModel):
    ...
    assigned_to_in_progress: Annotated[
        Optional[str], pydantic.Field(alias="assignedToInProgress")
    ] = None
    r"""The user which moved the step/task to the IN_PROGRESS state. The user should also be present in the assignedTo property of the step/task"""

    automation_config: Annotated[
        Optional[AutomationConfig], pydantic.Field(alias="automationConfig")
    ] = None
    r"""Configuration for automation execution to run"""
    ...
    execution_type: Annotated[
        Optional[StepType], pydantic.Field(alias="executionType")
    ] = None
    ...
    manually_created: Annotated[
        Optional[bool], pydantic.Field(alias="manuallyCreated")
    ] = None
