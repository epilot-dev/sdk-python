...
WorkflowExecutionSlimFlowTypedDict = TypeAliasType(
    "WorkflowExecutionSlimFlowTypedDict", Union[SectionTypedDict, StepTypedDict]
)


WorkflowExecutionSlimFlow = TypeAliasType(
...
class WorkflowExecutionSlim(BaseModel):
    ...
    closing_reason_description: Annotated[
        Optional[str], pydantic.Field(alias="closingReasonDescription")
    ] = None

    completed_time: Annotated[Optional[str], pydantic.Field(alias="completedTime")] = (
        None
    )
    r"""Completed time of the workflow execution"""

    configured_closing_reason_snapshot: Annotated[
        Optional[List[ClosingReason]],
        pydantic.Field(alias="configuredClosingReasonSnapshot"),
    ] = None
    ...
    last_modified_by: Annotated[
        Optional[str], pydantic.Field(alias="lastModifiedBy")
    ] = None
    r"""Id of the user who closed workflow"""
    ...
    next_open_step: Annotated[
        Optional[StepID], pydantic.Field(alias="nextOpenStep")
    ] = None

    org_id: Annotated[Optional[str], pydantic.Field(alias="orgId")] = None

    selected_closing_reasons: Annotated[
        Optional[List[ClosingReason]], pydantic.Field(alias="selectedClosingReasons")
    ] = None
