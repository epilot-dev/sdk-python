...
class DynamicDueDate:
    ...
    action_type_condition: Optional[ActionTypeCondition] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actionTypeCondition'), 'exclude': lambda f: f is None }})
