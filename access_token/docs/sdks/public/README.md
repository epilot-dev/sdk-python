...
with Epilot() as epilot:
    ...
    res = epilot.public.get_access_token_jwks()
...
with Epilot() as epilot:
    ...
    res = epilot.public.get_access_token_oidc()
...
with Epilot() as epilot:
    ...
    res = epilot.public.get_public_token_jwks()
...
with Epilot() as epilot:
    ...
    res = epilot.public.get_public_token_oidc()
