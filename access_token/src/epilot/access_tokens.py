...
class AccessTokens:
    ...
    def create_access_token(self, request: Optional[Union[shared.AccessTokenParameters, shared.JourneyTokenParameters]]) -> operations.CreateAccessTokenResponse:
        ...
        **Access Token type: `JOURNEY`**:
        ...
        res = operations.CreateAccessTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_access_tokens(self, token_type: Optional[List[shared.AccessTokenType]] = None) -> operations.ListAccessTokensResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListAccessTokensRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ListAccessTokensResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def revoke_access_token(self, id: str) -> operations.RevokeAccessTokenResponse:
        ...
        res = operations.RevokeAccessTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
