...
class Documents:
    ...
    def generate_document_v2(self, request_body: Optional[operations.GenerateDocumentV2RequestBody] = None, job_id: Optional[str] = None, mode: Optional[operations.GenerateDocumentV2Mode] = None) -> operations.GenerateDocumentV2Response:
