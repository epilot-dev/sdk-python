...
with Epilot(
    ...
    res = epilot.documents.generate_document_v2(mode=epilot_document.Mode.FULL_GENERATION, preview_mode=epilot_document.PreviewMode.OPEN, document_generation_v2_request={
        "template_document": {
