...
class File(BaseSDK):
    ...
    def save_file_v2(
        ...
        activity_id: Optional[str] = None,
        strict: Optional[bool] = False,
        save_file_payload_v2: Optional[Union[models.SaveFilePayloadV2, models.SaveFilePayloadV2TypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.FileEntity]:
        ...
        request = models.SaveFileV2Request(
            activity_id=activity_id,
            strict=strict,
            save_file_payload_v2=utils.get_pydantic_model(save_file_payload_v2, Optional[models.SaveFilePayloadV2]),
        )
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.save_file_payload_v2, False, True, "json", Optional[models.SaveFilePayloadV2]),
            timeout_ms=timeout_ms,
        )
