...
class Deprecated(BaseSDK):
    ...
    def save_file(
        ...
        save_file_payload: Optional[Union[models.SaveFilePayload, models.SaveFilePayloadTypedDict]] = None,
        ...
        request = models.SaveFileRequest(
            ...
            save_file_payload=utils.get_pydantic_model(save_file_payload, Optional[models.SaveFilePayload]),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.save_file_payload, False, True, "json", Optional[models.SaveFilePayload]),
