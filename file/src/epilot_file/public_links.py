...
class PublicLinks(BaseSDK):
    ...
    def list_public_links_for_file(
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.ListPublicLinksForFileResponseBody]:
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="listPublicLinksForFile", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.ListPublicLinksForFileResponseBody])
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def revoke_public_link(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="revokePublicLink", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["4XX","5XX"],
            retry_config=retry_config
        )
