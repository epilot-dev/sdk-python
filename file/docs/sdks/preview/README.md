...
s.preview.preview_file(id="ef7d985c-2385-44f4-9c71-ae06a52264f8")
...
s.preview.preview_public_file(request={
...
s.preview.preview_s3_file(s3_ref={
...
s.preview.preview_s3_file_get(bucket="<value>", key="<value>")
