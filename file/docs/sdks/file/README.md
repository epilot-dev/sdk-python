...
with Epilot(
    ...
    res = epilot.file.delete_file(id="ef7d985c-2385-44f4-9c71-ae06a52264f8", activity_id="01F130Q52Q6MWSNS8N2AVXV4JN", strict=False)
...
with Epilot(
    ...
    res = epilot.file.download_file(id="ef7d985c-2385-44f4-9c71-ae06a52264f8", attachment=True, version=0)
...
with Epilot(
    ...
    res = epilot.file.download_s3_file(s3_bucket="<value>", s3_key="<value>", attachment=True)
...
with Epilot(
    ...
    res = epilot.file.get_file(id="ef7d985c-2385-44f4-9c71-ae06a52264f8", async_=False, source_url=False, strict=False)
...
with Epilot(
    ...
    res = epilot.file.save_file_v2(activity_id="01F130Q52Q6MWSNS8N2AVXV4JN", async_=False, fill_activity=False, strict=False, save_file_payload_v2=epilot_file.SaveFileFromSourceURLPayload(
        tags=[
            "string",
        ],
