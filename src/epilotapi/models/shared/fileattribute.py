...
class FileAttribute:
    ...
    allowed_extensions: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allowed_extensions'), 'exclude': lambda f: f is None }})
    ...
    default_access_control: Optional[FileAttributeDefaultAccessControlEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('default_access_control'), 'exclude': lambda f: f is None }})
    ...
    display_images_landscaped: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('display_images_landscaped'), 'exclude': lambda f: f is None }})
    enable_description: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('enable_description'), 'exclude': lambda f: f is None }})
    ...
    multiple: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('multiple'), 'exclude': lambda f: f is None }})
