...
class SendEmailActionConfig:
    ...
    config: Optional[shared_sendemailconfig.SendEmailConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('config'), 'exclude': lambda f: f is None }})
