...
class CreateDocumentActionConfig:
    ...
    config: Optional[shared_createdocumentconfig.CreateDocumentConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('config'), 'exclude': lambda f: f is None }})
