...
class CurrencyAttributeCurrency1:
    ...
    flag: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('flag'), 'exclude': lambda f: f is None }})
...
class CurrencyAttribute:
    ...
    currency_selector_only: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('currency_selector_only'), 'exclude': lambda f: f is None }})
