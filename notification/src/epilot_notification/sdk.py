...
from epilot_notification._hooks import SDKHooks
from epilot_notification.notification_sdk import NotificationSDK
from epilot_notification.types import OptionalNullable, UNSET
import httpx
...
class Epilot(BaseSDK):
    ...
    def _init_sdks(self):
        self.notification = NotificationSDK(self.sdk_configuration)
