...
with Epilot(
    ...
    res = epilot.notification.get_notification(id=3493.28)
...
with Epilot(
    ...
    res = epilot.notification.get_notifications()
...
with Epilot(
    ...
    res = epilot.notification.get_notifications_v2()
...
with Epilot(
    ...
    res = epilot.notification.get_total_unread()
...
with Epilot(
    ...
    epilot.notification.mark_all_as_read()
...
with Epilot(
    ...
    epilot.notification.mark_as_read(id=883397)
