...
import dataclasses
from .closingreasonid import ClosingReasonID
...
class WorkflowDefinition:
    ...
    closing_reasons: Optional[List[ClosingReasonID]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('closingReasons'), 'exclude': lambda f: f is None }})
