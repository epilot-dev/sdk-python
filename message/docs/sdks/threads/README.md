...
* [mark_thread_as_done](#mark_thread_as_done) - markThreadAsDone
* [mark_thread_as_open](#mark_thread_as_open) - markThreadAsOpen
...
with Epilot(
    ...
    epilot.threads.mark_thread_as_done(id="<id>")
...
with Epilot(
    ...
    epilot.threads.mark_thread_as_open(id="<id>")
