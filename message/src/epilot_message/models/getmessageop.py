...
class GetMessageResponseBodyTypedDict(TypedDict):
    r"""Success"""
    ...
    send_status: NotRequired[List[GetMessageSendStatus]]
    ...
    type: NotRequired[GetMessageType]
    r"""Message type"""
...
class GetMessageResponseBody(BaseModel):
    ...
    send_status: Optional[List[GetMessageSendStatus]] = None
    r"""Sent message status. The array contains sending message status corresponding to all recipients. For more detail, check `send_status` of each recipient in `to`, `cc`, `bcc`            Reference at <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>
    ...
    type: Optional[GetMessageType] = None
    r"""Message type"""
...
class GetMessageResponseTypedDict(TypedDict):
    ...
    result: GetMessageResponseBodyTypedDict


class GetMessageResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetMessageResponseBody
