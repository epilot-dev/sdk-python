...
class CreateDraftSendStatus(str, Enum):
    SEND = "SEND"
    DELIVERY = "DELIVERY"
    REJECT = "REJECT"
    COMPLAINT = "COMPLAINT"
...
class CreateDraftType(str, Enum):
    r"""Message type"""
...
class CreateDraftResponseBodyTypedDict(TypedDict):
    r"""Success"""
    ...
    send_status: NotRequired[List[CreateDraftSendStatus]]
...
class CreateDraftResponseBody(BaseModel):
    ...
    send_status: Optional[List[CreateDraftSendStatus]] = None
    r"""Sent message status. The array contains sending message status corresponding to all recipients. For more detail, check `send_status` of each recipient in `to`, `cc`, `bcc`            Reference at <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>
    ...
    type: Optional[CreateDraftType] = None
    r"""Message type"""
