...
class MessageV2TypedDict(TypedDict):
    created_at: datetime
    r"""Created date"""
    id: str
    r"""Entity ID"""
    ...
    r"""HTML body"""
    html_download_url: NotRequired[str]
    r"""HTML body download URL"""
    html_omitted: NotRequired[bool]
    ...
    r"""Organization ID of organization read the message."""
    ...
    send_status: NotRequired[List[MessageV2SendStatus]]
    ...
    r"""User ID of user sends the message."""
    ...
    type: NotRequired[MessageV2Type]
    r"""Message type"""
    user_read_message: NotRequired[List[str]]
    r"""User ID of user read the message."""
...
class MessageV2(BaseModel):
    ...
    html_omitted: Optional[bool] = False
    r"""If true then html is not provided and must be downloaded using the html_download_url"""
    ...
    send_status: Optional[List[MessageV2SendStatus]] = None
    r"""Sent message status. The array contains sending message status corresponding to all recipients. For more detail, check `send_status` of each recipient in `to`, `cc`, `bcc`            Reference at <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>
    ...
    type: Optional[MessageV2Type] = None
    r"""Message type"""
