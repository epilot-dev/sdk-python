...
class UpdateMessageSendStatus(str, Enum):
    SEND = 'SEND'
    DELIVERY = 'DELIVERY'
    REJECT = 'REJECT'
    COMPLAINT = 'COMPLAINT'
...
class UpdateMessageResponseBody:
    ...
    send_status: Optional[List[UpdateMessageSendStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[UpdateMessageType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Message type"""
...
class UpdateMessageResponse:
    ...
    object: Optional[UpdateMessageResponseBody] = dataclasses.field(default=None)
    r"""Success"""
