...
class SendDraftResponseBody:
    ...
    send_status: Optional[List[SendDraftSendStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[SendDraftType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Message type"""
...
class SendDraftResponse:
    ...
    object: Optional[SendDraftResponseBody] = dataclasses.field(default=None)
    r"""Success"""
