...
class SendDraft201ApplicationJSONSendStatusEnum(str, Enum):
    SEND = "SEND"
    DELIVERY = "DELIVERY"
    REJECT = "REJECT"
    COMPLAINT = "COMPLAINT"
...
class SendDraft201ApplicationJSONTypeEnum(str, Enum):
    r"""Message type"""
    SENT = "SENT"
    RECEIVED = "RECEIVED"
...
class SendDraft201ApplicationJSON:
    r"""Success"""
    ...
    send_status: Optional[list[SendDraft201ApplicationJSONSendStatusEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[SendDraft201ApplicationJSONTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Message type"""  
...
class SendDraftResponse:
    ...
    send_draft_201_application_json_object: Optional[SendDraft201ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
