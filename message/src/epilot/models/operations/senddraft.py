...
class SendDraft201ApplicationJSONSendStatus(str, Enum):
    SEND = 'SEND'
    DELIVERY = 'DELIVERY'
    REJECT = 'REJECT'
    COMPLAINT = 'COMPLAINT'
...
class SendDraft201ApplicationJSONType(str, Enum):
    r"""Message type"""
    SENT = 'SENT'
    RECEIVED = 'RECEIVED'
...
class SendDraft201ApplicationJSON:
    ...
    send_status: Optional[list[SendDraft201ApplicationJSONSendStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[SendDraft201ApplicationJSONType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Message type"""
