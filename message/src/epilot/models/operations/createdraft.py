...
class CreateDraft201ApplicationJSONSendStatus(str, Enum):
    SEND = 'SEND'
    DELIVERY = 'DELIVERY'
    REJECT = 'REJECT'
    COMPLAINT = 'COMPLAINT'
...
class CreateDraft201ApplicationJSONType(str, Enum):
    r"""Message type"""
    SENT = 'SENT'
    RECEIVED = 'RECEIVED'
...
class CreateDraft201ApplicationJSON:
    r"""Success"""
    ...
    send_status: Optional[list[CreateDraft201ApplicationJSONSendStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[CreateDraft201ApplicationJSONType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Message type"""
