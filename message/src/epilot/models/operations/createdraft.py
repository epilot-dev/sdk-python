...
class CreateDraftResponseBody:
    ...
    send_status: Optional[List[SendStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('send_status'), 'exclude': lambda f: f is None }})
...
class CreateDraftResponse:
    ...
    object: Optional[CreateDraftResponseBody] = dataclasses.field(default=None)
    r"""Success"""
