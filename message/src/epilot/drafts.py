...
class Drafts:
    ...
    def create_draft(self, request: Optional[components.MessageRequestParams]) -> operations.CreateDraftResponse:
        ...
        res = operations.CreateDraftResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def send_draft(self) -> operations.SendDraftResponse:
        ...
        res = operations.SendDraftResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
