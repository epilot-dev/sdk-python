...
with Epilot(
    ...
    res = epilot.group.create_group(request={
        "name": "Finance",
        "user_ids": [
            "123",
            "456",
...
with Epilot(
    ...
    epilot.group.delete_group(id="<id>")
...
with Epilot(
    ...
    res = epilot.group.get_group(id="<id>")
...
with Epilot(
    ...
    res = epilot.group.update_group(id="<id>", name="Finance", user_ids=[
        "123",
        "456",
    ])
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `id`                                                                | *str*                                                               | :heavy_check_mark:                                                  | Group id                                                            |                                                                     |
| `name`                                                              | *Optional[str]*                                                     | :heavy_minus_sign:                                                  | The name of the group. Could be a department or a team.             | Finance                                                             |
