...
with Epilot() as epilot:
    epilot.user_v2.activate_user(token="<value>", user_activation_payload={
...
with Epilot() as epilot:
    res = epilot.user_v2.sign_up_user(signup_user_payload={
...
with Epilot(
    ...
    res = epilot.user_v2.update_user_v2(id="<id>", user_v2={
        "department": "Sales",
        "display_name": "Example User",
...
with Epilot() as epilot:
    epilot.user_v2.verify_email_with_token(token="<value>", user_verification_payload={
        "password": "AKjhdakjsdh@!34",
    })
