...
with Epilot(
    ...
    res = epilot.user_v2.invite_user(request={
        ...
        "language": epilot_user.UserInvitationPayloadLanguage.EN,
        "roles": [
            "123:owner",
        ],
    })
...
with Epilot(
    ...
    res = epilot.user_v2.resend_user_invitation(request={
        "email": "test@example.com",
        "language": epilot_user.ResendUserInvitationLanguage.EN,
    })
...
with Epilot() as epilot:
    ...
    res = epilot.user_v2.sign_up_user(signup_user_payload=epilot_user.SignupUserPayload(
        language=epilot_user.Language.EN,
...
with Epilot(
    ...
    res = epilot.user_v2.update_user_v2(id="<id>", custom_start_page="/app/dashboard", department="Sales", display_name="Example User", email_notification_setting={
