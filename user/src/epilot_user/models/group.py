...
class CrtAssignee(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["created_at", "crt_index", "custom_start_page", "department", "display_name", "draft_email", "email", "favorites", "feature_preferences", "id", "image_uri", "is_signature_enabled", "mfa_enabled", "organization_id", "override_release_channel", "phone", "phone_verified", "preferred_language", "properties", "secondary_phone", "signature", "status", "token"]
