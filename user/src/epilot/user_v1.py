...
class UserV1:
    ...
    def get_me(self) -> operations.GetMeResponse:
        ...
        res = operations.GetMeResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_user_login_parameters(self, username: str) -> operations.GetUserLoginParametersResponse:
        ...
        res = operations.GetUserLoginParametersResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
