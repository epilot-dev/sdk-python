...
class Variables:
    ...
    def get_categories(self, lang: Optional[str] = None) -> operations.GetCategoriesResponse:
        ...
        query_params = { **utils.get_query_params(operations.GetCategoriesRequest, request), **query_params }
        ...
        res = operations.GetCategoriesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_variable_context(self, request: Optional[operations.GetVariableContextRequestBody]) -> operations.GetVariableContextResponse:
        ...
        res = operations.GetVariableContextResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def replace_templates(self, request: Optional[operations.ReplaceTemplatesRequestBody]) -> operations.ReplaceTemplatesResponse:
        ...
        res = operations.ReplaceTemplatesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def search_variables(self, request: Optional[operations.SearchVariablesRequestBody]) -> operations.SearchVariablesResponse:
        ...
        res = operations.SearchVariablesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
